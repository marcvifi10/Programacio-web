	...
	<body>
		<?php
				...
				if (isset($_GET["CompanyName"])) 
				{
					...
					$client = $_GET["CompanyName"];

				}

				$query = "SELECT CompanyName FROM customers GROUP BY CompanyName ORDER BY CompanyName";
		...
		<script>
			...
			$(function() 
			{
				...
				$(document).on("click",".fila_client1",function()
				{

					var orderID = $(this).children(":first").html();

					$.ajax(
					{
						url: "dbquery2.php?OrderID="+orderID,
						method: "get",
						dataType: "html",
						success: function (data, status) 
						{
